...
$fctura = 0 ;
$empsa = "" ;
$registros = $bd->query("SELECT `NumPartida`, `Monto`, `Descripcion`, `Factura`, `Empresa` FROM `partidas` where `NumPartida`=21102");
...
Descripci&oacute;n de Partida: <input type= "text" id="NumPart" value ="<?php echo $dscr; ?>" ><br>
N&uacute;mero de Factura<input type= "text" id="NumPart" value ="<?php echo $fctura; ?>" class = "w3-input w3-border w3-margin-bottom"><br>
